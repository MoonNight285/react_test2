...
var x = x;
var y = y;
// object 생성 시 키 값을 설정하지않으면 변수명이 키값으로 생성된다.
var obj = {x, y};
console.log(obj);

// object 타입 생성 시 대입 연산자 오른쪽에서 바로 키와 값을 설정하여 object 타입에 데이터를 추가하는 것이
// 가능하다.
var randomKeyString = 'other';
...
var list = [0, 1];
// 대입 연산자 왼쪽에 [] 를 사용하여 그 안에 배열을 쓰듯이 변수명을 입력하면 오른쪽의 대입 연산자 오른쪽의 데이터를 
...
// 대입 연산자 왼쪽에 {} 을 사용하고 변수명을 입력하면, 대입 연산자 오른쪽의 object 타입의 키와
// 같은 변수명에 데이터를 저장한다.
